...
int main()
{
    ...
    // These theree values will correct and/or reduce the error of the car
    pid.Init(0.09, 0.001, 2.00);
                    ...
                    if (length && length > 2 && data[0] == '4' && data[1] == '2')
                    {
                        ...
                        if (s != "")
                        {
                            ...
                            if (event == "telemetry")
                            {
                                ...
                                {
                                    std::cout << "Invalid value. Value must be between -1 and 1" << std::endl;
                                }

                                // According to the TODO statement the steer value must be -1 and 1
                                if (steer_value > 1)
                                {
                                    steer_value = 1;
                                }
